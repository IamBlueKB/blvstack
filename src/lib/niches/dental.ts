...
export const dental: NicheConfig = {
  slug: 'dental',
  label: 'Dental Practice',
  status: 'scaffold',

  detection: {
    keywords: ['dental', 'dentist', 'orthodont', 'invisalign' /* TODO expand */],
    domainHints: ['dental', 'dentist', 'smile', 'ortho'],
    googlePlacesTypes: ['dentist'],
  },
